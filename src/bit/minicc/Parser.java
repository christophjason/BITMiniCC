 ...
 * RARG_LIST		: , ID RARG_LIST2 | , CONST RARG_LIST2 | e 
 ...
 * FACTOR		: ID | CONST ( EXPR ) | ID (REAL_ARG_LIST)
 */
 /*
 * int main(){
 * 	int i;
...
public class Parser {
	...
	public TreeNode decl_stmt(){
		TreeNode n = new TreeNode();
		n.setType(TreeNodeType.TNT_DECL_STMT);
	...
	public TreeNode rtn_stmt(){
		TreeNode n = new TreeNode();
		n.setType(TreeNodeType.TNT_RTN_STMT);
